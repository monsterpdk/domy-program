                        ...
                        'items'=>array (
		                        ...
		                        'items'=>array (
	                            	array ('label'=>'Nyomdagépek kezelése', 'url'=> Yii::app()->createUrl('/nyomdagepek/index'), 'visible'=>Yii::app()->user->checkAccess('Admin')),
																...
																array ('label'=>'Munkatípusok kezelése', 'url'=> Yii::app()->createUrl('/nyomdaMunkatipusok/index'), 'visible'=>Yii::app()->user->checkAccess('Admin')),
																array ('label'=>'Művelet árak kezelése', 'url'=> Yii::app()->createUrl('/nyomdaMuveletNormaarak/index'), 'visible'=>Yii::app()->user->checkAccess('Admin')),
																array ('label'=>'Nyomdakönyvi beállítások', 'url'=> Yii::app()->createUrl('/nyomdakonyvBeallitasok/index'), 'visible'=>Yii::app()->user->checkAccess('Admin')),
															)),	                                                                          
		                        ...
		                        'items'=>array (
	                            	array ('label'=>'Alapértelmezett beállítások', 'url'=> Yii::app()->createUrl('/szamlazoBeallitasok/index'), 'visible'=>Yii::app()->user->checkAccess('Admin')),
	                            	array ('label'=>'Fizetési módok', 'url'=> Yii::app()->createUrl('/fizetesiModok/index'), 'visible'=>Yii::app()->user->checkAccess('Admin')),
