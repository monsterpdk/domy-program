...
/**
 * Ügyfél rendelései statisztika 'kereső' modelje.
 */
class StatisztikakUgyfelRendelesei extends CFormModel
{
        ...
        {
                return array(
                	array('statisztika_mettol, statisztika_meddig, ugyfel_id', 'required'),
