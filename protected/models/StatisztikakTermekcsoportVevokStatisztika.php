...
/**
 * Termékcsoport vevők statisztika 'kereső' modelje.
 */
class StatisztikakTermekcsoportVevokStatisztika extends CFormModel
{
        ...
        public function rules()
        {
                return array(
					...
					array('termekcsoport_id', 'numerical', 'integerOnly'=>true),
                );
        }
