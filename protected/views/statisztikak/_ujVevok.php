	...
	<div class="row">
		...
		<?php echo $form->labelEx($model,'stat_type_filter'); ?>
			...
			<div class="statChooser" style='margin-bottom:20px;'>
				<?php 
					echo $form -> radioButtonList($model, 'stat_type_filter', array("elso_arajanlat" => "első árajánlat", "elso_megrendeles" => "első megrendelés"), array( 'separator' => "  ", 'template' => '{input} {label} <br />')); 
				?>
			</div>
