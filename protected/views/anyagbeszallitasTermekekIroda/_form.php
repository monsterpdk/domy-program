<?php
/* @var $this AnyagbeszallitasTermekekIrodaIrodaController */
/* @var $model AnyagbeszallitasTermekekIrodaIroda */
								...
								array(
								  ...
								  'value'=>'CHtml::Button("+", 
															array("name" => "send_termek", 
																...
																$(\"#AnyagbeszallitasTermekekIroda_netto_darabar\").val(\"$data->activeTermekAr\");
