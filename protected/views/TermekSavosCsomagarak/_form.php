...
?>
	...
	<?php echo $form->hiddenField($model, 'termek_ar_id'); ?>
	
	<div class="row">
		<?php echo $form->labelEx($model,'csomagszam_tol'); ?>
		<?php echo $form->textField($model,'csomagszam_tol',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'csomagszam_tol'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'csomagszam_ig'); ?>
		<?php echo $form->textField($model,'csomagszam_ig',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'csomagszam_ig'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'csomag_ar_szamolashoz'); ?>
		<?php echo $form->textField($model,'csomag_ar_szamolashoz',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'csomag_ar_szamolashoz'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'csomag_ar_nyomashoz'); ?>
		<?php echo $form->textField($model,'csomag_ar_nyomashoz',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'csomag_ar_nyomashoz'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'csomag_eladasi_ar'); ?>
		<?php echo $form->textField($model,'csomag_eladasi_ar',array('size'=>10,'maxlength'=>10)); ?>
