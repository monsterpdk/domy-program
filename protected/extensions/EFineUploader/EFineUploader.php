...
class EFineUploader extends CWidget
{
		...
		$assets = dirname(__FILE__).'/assets';
                ...
                $fJs=(YII_DEBUG)?$baseUrl."/jquery.fineuploader-{$this->version}.min.js":$baseUrl."/jquery.fineuploader-{$this->version}.min.js";
				...
				$this->css2=(!empty($this->css2))?$this->css2:$baseUrl."/fine-uploader-gallery.min.css";
                Yii::app()->clientScript->registerCssFile($this->css2);
				
				$this->css3=(!empty($this->css3))?$this->css3:$baseUrl."/fine-uploader-new.min.css";
                Yii::app()->clientScript->registerCssFile($this->css3);
