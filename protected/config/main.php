...
return array(
	...
	'components'=>array(
		...
		// LI : utils, általánosan használt metódusok gyűjteménye
		'utils'=>array(
		...
		// LI : boolean formatter, hogy ne Yes/No legyen, hanem Igen/Nem
		'format'=>array(
			'class'=>'application.components.Formatter',
		),
		// LI : egy komponens, ami 'real-time' tölti be egy dropdown-ba egy tábla megadott ENUM mezőjének értékeit
		'dhtml'=>array(
			'class'=>'application.components.DHtml',
		),
		'urlManager'=>array(
			'urlFormat'=>'path',
			'rules'=>array(
		...
		'db_actual'=>array(
			'class'=>'CDbConnection',
			'connectionString' => 'sqlsrv:Server=DOMYSRV\ACTUAL1;Database=Kronos0001',
//			'emulatePrepare' => false,
	...
	'params'=>array(
		...
		'hostInfo'=>'http://domywebdev.dyndns.org:82',		
	),
);