...
class GyartokController extends Controller
{
	...
	{
		$model=new Gyartok('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Gyartok']))
			$model->attributes=$_GET['Gyartok'];
	 ...
	 * @return Gyartok the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Gyartok::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Gyartok $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='gyartok-form')
		{
