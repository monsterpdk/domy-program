...
class MegrendelesekController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if (isset($_POST['Megrendelesek']))
		{
			...
			$model -> sorszam = "MR" . str_pad( ($utolsoMegrendeles != null) ? ($utolsoMegrendeles + 1) : "0001", 4, '0', STR_PAD_LEFT );
	...
	public function actionCreateFromArajanlat ()
	{
		if ( isset($_POST['arajanlat_id']) && isset($_POST['selected_tetel_list']) ) {
			...
			$megrendeles -> sorszam = "MR" . str_pad( ($utolsoMegrendeles != null) ? ($utolsoMegrendeles + 1) : "0001", 4, '0', STR_PAD_LEFT );
