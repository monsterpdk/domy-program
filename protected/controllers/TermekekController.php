	...
	public function actionIndex()
	{
		...
		// LI : exporthoz kell ez a blokk
		 if ($this->isExportRequest()) {
			...
			// mindig az aktuális
            $this->exportCSV($dataProvider, array('id', 'nev', 'kodszam', 'meret.id', 'meret.nev', 'suly', 'zaras.id', 'zaras.nev', 'ablakmeret.id', 'ablakmeret.nev', 'ablakhely.id', 'ablakhely.nev', 'papirtipus.id', 'papirtipus.nev', 'afakulcs.id', 'afakulcs.afa_szazalek', 'redotalp', 'gyarto.id', 'gyarto.cegnev', 'ksh_kod', 'csom_egys', 'minimum_raktarkeszlet', 'maximum_raktarkeszlet', 'doboz_suly', 'raklap_db', 'doboz_hossz', 'doboz_szelesseg', 'doboz_magassag', 'megjegyzes', 'megjelenes_mettol', 'megjelenes_meddig', 'datum', 'torolt'));
        }
