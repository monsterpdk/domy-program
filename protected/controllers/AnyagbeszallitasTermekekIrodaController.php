...
class AnyagbeszallitasTermekekIrodaController extends Controller
{
	...
	public function actionCreate($id, $gyarto_id, $anyagrendeles_id, $bizonylatszam, $grid_id)
	{
	    ...
	    $model=new AnyagbeszallitasTermekekIroda;
		...
		if (isset($_GET['ajax']) && strpos($_GET['ajax'], 'termekek-iroda-grid') !== FALSE) {
        ...
        if(isset($_POST['AnyagbeszallitasTermekekIroda']))
        {
            $model->attributes=$_POST['AnyagbeszallitasTermekekIroda'];
            if($model->save())
            {
        ...
        if (Yii::app()->request->isAjaxRequest)
        {
            ...
            $this->render('create',array('model'=>$model, 'termek' => $termek,));
		}
	...
	{
		$model=new AnyagbeszallitasTermekekIroda('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['AnyagbeszallitasTermekekIroda']))
			$model->attributes=$_GET['AnyagbeszallitasTermekekIroda'];
	 ...
	 * @return AnyagbeszallitasTermekekIroda the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=AnyagbeszallitasTermekekIroda::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param AnyagbeszallitasTermekekIroda $model the model to be validated
	 */
