...
class UgyfelUgyintezokController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('UgyfelUgyintezok',
	...
	{
		$model=new UgyfelUgyintezok('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UgyfelUgyintezok']))
			$model->attributes=$_GET['UgyfelUgyintezok'];
	 ...
	 * @return UgyfelUgyintezok the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=UgyfelUgyintezok::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param UgyfelUgyintezok $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ugyfel-ugyintezok-form')
		{
