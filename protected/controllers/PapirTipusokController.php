...
class PapirTipusokController extends Controller
{
	...
	{
		$model=new PapirTipusok;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['PapirTipusok']))
		{
	...
	{
		$model=new PapirTipusok('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PapirTipusok']))
			$model->attributes=$_GET['PapirTipusok'];
	 ...
	 * @return PapirTipusok the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=PapirTipusok::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param PapirTipusok $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='papir-tipusok-form')
		{
