...
class NyomdaMunkatipusokController extends Controller
{
	...
	{
		$model=new NyomdaMunkatipusok('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['NyomdaMunkatipusok']))
			$model->attributes=$_GET['NyomdaMunkatipusok'];
	 ...
	 * @return NyomdaMunkatipusok the loaded model
	 ...
	 * @param NyomdaMunkatipusok $model the model to be validated
	 */
