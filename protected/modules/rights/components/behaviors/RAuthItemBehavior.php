...
class RAuthItemBehavior extends CBehavior
{
	...
	* @return string the markup. 
	*/
	public function getGridDescriptionLink()
	{
		$markup = CHtml::link($this->owner->description, array(
			'authItem/update',
			'name'=>urlencode($this->owner->name),
		));
	...
	/**
	* Returns the markup for the description link to displayed in the grid.
	* @return string the markup. 
	*/
